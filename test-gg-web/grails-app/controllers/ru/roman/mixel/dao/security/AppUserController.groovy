...
class AppUserController {
    ...
    def save = {
        ...
        if (daoService.executeInTransaction {appUserInstance.save(flush: true)}) {
    ...
    def update = {
        ...
        if (appUserInstance) {
            ...
            appUserInstance.properties = params
            if (!appUserInstance.hasErrors() && daoService.executeInTransaction {appUserInstance.save(flush: true)}) {
    ...
    def delete = {
        ...
        if (appUserInstance) {
            try {
                daoService.executeInTransaction {appUserInstance.delete(flush: true)}
