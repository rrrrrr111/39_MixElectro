...
class MainMenuController {
    ...
    def save = {
        ...
        if (daoService.executeInTransaction {mainMenuInstance.save(flush: true)}) {
    ...
    def update = {
        ...
        if (mainMenuInstance) {
            ...
            mainMenuInstance.properties = params
            if (!mainMenuInstance.hasErrors() && daoService.executeInTransaction {mainMenuInstance.save(flush: true)}) {
    ...
    def delete = {
        ...
        if (mainMenuInstance) {
            try {
                daoService.executeInTransaction {mainMenuInstance.delete(flush: true)}
