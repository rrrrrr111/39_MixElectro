                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="description"><g:message code="appRole.description.label" default="Description" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: appRoleInstance, field: 'description', 'errors')}">
                                    <g:textField style="width:1000px;" name="description" value="${appRoleInstance?.description}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="appRole.name.label" default="Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: appRoleInstance, field: 'name', 'errors')}">
                                    <g:textField style="width:1000px;" name="name" value="${appRoleInstance?.name}" />
                                </td>
                            </tr>
