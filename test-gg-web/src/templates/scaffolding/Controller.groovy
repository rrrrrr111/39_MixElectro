...
class ${className}Controller {
    ...
    def save = {
        ...
        if (daoService.executeInTransaction {${propertyName}.save(flush: true)}) {
    ...
    def update = {
        ...
        if (${propertyName}) {
            ...
            ${propertyName}.properties = params
            if (!${propertyName}.hasErrors() && daoService.executeInTransaction {${propertyName}.save(flush: true)}) {
    ...
    def delete = {
        ...
        if (${propertyName}) {
            try {
                daoService.executeInTransaction {${propertyName}.delete(flush: true)}
